...
const Hero = () => {
  return (
    <div id={'home'} className="flex flex-col md:flex-row gap-5 py-10">
      ...
      <div className={'break-normal w-64'}>
        ...
        <p className={'break-normal mt-3'}>I’m a web developer, passionate about diving into new initiatives</p>
      </div>
